...
void VirusTooth::disappear(void)
{
    ...
    m_pSprite->runAction(Spawn::create(FadeOut::create(0.8f),Sequence::create(ScaleTo::create(0.01f,0.01),ScaleTo::create(0.5f,1.0), NULL) ,NULL));
...
void VirusTooth::setSpawn(Vec2 pos)
{
    ...
    Sequence* pSequence = Sequence::create(ScaleTo::create(1.0f,1.1f,1.0f),ScaleTo::create(1.0f,1.0f,1.0f), NULL);
